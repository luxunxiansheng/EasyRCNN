...
_C.RPN.PROPOSAL_TARGET_CREATOR.LOC_NORM_MEAN = [0.0, 0.0, 0.0, 0.0]
_C.RPN.PROPOSAL_TARGET_CREATOR.LOC_NORM_STD = [0.1, 0.1, 0.2, 0.2]
...
_C.FASTER_RCNN.LOC_NORM_MEAN = [0.0, 0.0, 0.0, 0.0]
_C.FASTER_RCNN.LOC_NORM_STD = [0.1, 0.1, 0.2, 0.2]
